...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([[
      InlineKeyboardButton('📢 channel', url='https://t.me/XANIME_UNIVERSE'),
      InlineKeyboardButton('💬 Support', url='https://t.me/xanime_chat_group')
    ],[
      InlineKeyboardButton('⚙️ Help', callback_data='help'),
      InlineKeyboardButton('💙 About', callback_data='about')
    ],[
        InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url='https://t.me/Dumb_luffy')
    ]])
    if Config.START_PIC:
